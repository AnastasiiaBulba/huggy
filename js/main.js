...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  await loadPartial("header", "./huggy_partials/header.html");
  await loadPartial("footer", "./huggy_partials/footer.html");
  if (window.location.pathname.includes("huggy-contacts.html")) {
    await loadPartial("contact-info", "./huggy_partials/contact-info.html");
  }
  ...
  console.log("Huggy Mix Sprunki Music Box website initialized successfully!");
});
